...
export const CardTitle = props => (
  <div
    className={classnames(
      'text-sm sm:text-base text-accent-1 text-center',
      props.className,
    )}
  >
    {props.children}
...
export const CardPrimaryText = props => (
  <div
    className={classnames(
      'text-base sm:text-4xl font-bold text-white',
      props.className,
      {
...
export const CardSecondaryText = props => (
  <div
    className={classnames('text-xs sm:text-sm text-accent-1', props.className)}
  >
    {props.children}
  </div>
)
