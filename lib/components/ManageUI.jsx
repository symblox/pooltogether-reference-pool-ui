...
export const ManageUI = props => {
  const [selectedTab, setSelectedTab] = useState(
    window.location.hash || MANAGE_VIEW.stats,
  )
  ...
  return (
    <div className="flex mt-10 mb-10 sm:mb-20 lg:justify-between">
      <div className="flex-grow">
        <h1 className="text-accent-1 title text-xl sm:text-6xl">
...
const PoolAddress = () => {
  ...
  return (
    <>
      <div className="text-accent-1 font-bold title text-lg sm:text-4xl">
        Pool's Info
      </div>
