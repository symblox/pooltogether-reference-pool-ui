...
import {
  TextInputGroup,
  TextInputGroupType,
} from 'lib/components/TextInputGroup'
import {
    ...
    <Card>
      <Collapse title="Fairness">
        ...
        <CardSecondaryText className="mb-8">
          When a user deposits, they are instantly eligible to win. To maintain
          fairness a time decay early exit is enforced. All early exit fees
          accrue to the prize.
        </CardSecondaryText>
...
const FairnessControlsForm = props => {
  ...
  const [
    ...
    setTicketCreditMaturationInDays,
