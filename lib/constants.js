// import PermitAndDepositDaiRinkeby from '@symblox/pvlx-contracts/deployments/rinkeby/PermitAndDepositDai.json'
// import PermitAndDepositDaiMainnet from '@symblox/pvlx-contracts/deployments/mainnet/PermitAndDepositDai.json'

// import CompoundPrizePoolProxyMainnet from '@symblox/pvlx-contracts/deployments/mainnet/CompoundPrizePoolProxyFactory.json'
// import CompoundPrizePoolProxyRinkeby from '@symblox/pvlx-contracts/deployments/rinkeby/CompoundPrizePoolProxyFactory.json'
// import CompoundPrizePoolProxyRopsten from '@symblox/pvlx-contracts/deployments/ropsten/CompoundPrizePoolProxyFactory.json'

// import StakePrizePoolProxyMainnet from '@symblox/pvlx-contracts/deployments/mainnet/StakePrizePoolProxyFactory.json'
// import StakePrizePoolProxyRinkeby from '@symblox/pvlx-contracts/deployments/rinkeby/StakePrizePoolProxyFactory.json'
// import StakePrizePoolProxyRopsten from '@symblox/pvlx-contracts/deployments/ropsten/StakePrizePoolProxyFactory.json'
import StakePrizePoolProxyVlxtest from 'lib/deployments/vlxtest/SyxPrizePoolProxyFactory.json'

// import RNGBlockhashMainnet from '@symblox/pvlx-rng-contracts/deployments/mainnet/RNGBlockhash.json'
// import RNGBlockhashRinkeby from '@symblox/pvlx-rng-contracts/deployments/rinkeby/RNGBlockhash.json'
// import RNGBlockhashRopsten from '@symblox/pvlx-rng-contracts/deployments/ropsten/RNGBlockhash.json'
import RNGBlockhashVlxmain from '@symblox/pvlx-rng-contracts/deployments/vlxmain/RNGBlockhash.json'
import RNGBlockhashVlxtest from '@symblox/pvlx-rng-contracts/deployments/vlxtest/RNGBlockhash.json'

// import RNGChainlinkMainnet from '@symblox/pvlx-rng-contracts/deployments/mainnet/RNGChainlink.json'
// import RNGChainlinkRinkeby from '@symblox/pvlx-rng-contracts/deployments/rinkeby/RNGChainlink.json'

export const SENTINEL_ADDRESS = '0x0000000000000000000000000000000000000001'

export const SUPPORTED_NETWORKS = [1, 3, 4, 42, 106, 111, 31337, 1234]
...
export const CONTRACT_ADDRESSES = {
  ...
  106: {
    RNG_SERVICE: {
      blockhash: RNGBlockhashVlxmain.address,
    },
  },
  111: {
    // COMPOUND_PRIZE_POOL_PROXY: CompoundPrizePoolProxyRinkeby.address,
    // STAKE_PRIZE_POOL_PROXY: StakePrizePoolProxyVlxtest.address,
    RNG_SERVICE: {
      blockhash: RNGBlockhashVlxtest.address,
    },
  },
}
...
export const BLOCK_NUMBERS = {
  1: {
    // COMPOUND_PRIZE_POOL_PROXY:
    //   CompoundPrizePoolProxyMainnet.receipt.blockNumber,
  ...
  4: {
    // COMPOUND_PRIZE_POOL_PROXY:
    //   CompoundPrizePoolProxyRinkeby.receipt.blockNumber,
...
export const DEFAULT_INPUT_GROUP_CLASSES =
  'trans py-2 px-5 sm:py-4 sm:px-10 bg-body'

const domain =
  process.env.NEXT_JS_DOMAIN_NAME && `.${process.env.NEXT_JS_DOMAIN_NAME}`
...
export const TOKEN_NAMES = {
  106: {
    '0x01Db6ACFA20562Ba835aE9F5085859580A0b1386': 'SYX',
  },
  111: {
    '0x28a6312D786e9d7a78637dD137AbeF5332F3b2Aa': 'SYX',
  },
}
